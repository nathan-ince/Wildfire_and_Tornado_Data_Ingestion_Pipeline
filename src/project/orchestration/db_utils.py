...
def initialize_main_process(pipeline_name: str, main_process_id: UUID, main_process_start_timestamp: datetime) -> None:
  try:
    ...
    sql = read_sql_statement("initialize_main_process.sql")
    ...
    logger.exception("initialize_main_process failed")
...
def initialize_batch_process(source_name: str, main_process_id: UUID, batch_process_id: UUID, batch_process_start_timestamp: datetime) -> None:
  try:
    ...
    sql = read_sql_statement("initialize_batch_process.sql")
    ...
    logger.exception("initialize_batch_process failed")
...
def finalize_main_process(main_process_id: UUID, main_process_status: Status, main_process_final_timestamp: datetime) -> None:
  try:
    ...
    sql = read_sql_statement("finalize_main_process.sql")
    ...
    logger.exception("finalize_main_process failed")
...
def finalize_batch_process(batch_process_id: UUID, batch_process_status: Status, batch_process_final_timestamp: datetime) -> None:
  try:
    ...
    sql = read_sql_statement("finalize_batch_process.sql")
    ...
    logger.exception("finalize_batch_process failed")
