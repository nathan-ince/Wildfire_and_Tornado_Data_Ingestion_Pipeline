...
from project.utils import load_stmt_from_sql

INITIALIZE_MAIN_PROCESS = load_stmt_from_sql("initialize_main_process.sql")
INITIALIZE_BATCH_PROCESS = load_stmt_from_sql("initialize_batch_process.sql")
FINALIZE_MAIN_PROCESS = load_stmt_from_sql("finalize_main_process.sql")
FINALIZE_BATCH_PROCESS = load_stmt_from_sql("finalize_batch_process.sql")
