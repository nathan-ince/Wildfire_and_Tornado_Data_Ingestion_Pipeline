...
#     # accepts name, df "utils/postgres_manager/load_into...)"
...
#     monkeypatch.setattr(runner, "load_to_postgres", load_maybe_fail) # accepts name, df "utils/postgres_manager/load_into...)"
